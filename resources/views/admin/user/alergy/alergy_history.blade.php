                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <ul class="nav nav-tabs">
                                  <li>
                                  <a  href="{{ url('/admin/medical_history') }}" class="btn btn-xs btn-info pull-right">General</a></li>
                                  <li class="active">
                              ...
                              <div class="tab-content">
                                  ...
                                  <a href="{{route('admin.alergic_history.create')}}" class="btn btn-info btn-fill pull-right">Add Alergy</a>
