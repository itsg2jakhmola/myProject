  ...
  <body>
    <div class="navbar-wrapper">
      <div class="container">
        <nav class="navbar navbar-inverse navbar-static-top">
          <div class="top-nav">
            <ul>
                <li><a href="{{ url('login') }}" id="patientClick"><img src="images/patients-icon.png"> Patients</a></li>
                <li><a href="{{ url('login') }}" id="doctorClick"><img src="images/doctor-icon.png"> Doctor</a></li>
                <li><a href="{{ url('login') }}" id="pharmistClick"><img src="images/pharmacies-icon.png"> Pharmacies</a></li>
            </ul>   
          </div>
          <div class="container">
    ...
    <div id="bootstrap-touch-slider" class="carousel bs-slider fade  control-round indicators-line" data-ride="carousel" data-pause="hover" data-interval="5000" >
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <div class="item active">
                ...
                <div class="bs-slider-overlay"><img src="images/overlay.png"></div>
                <div class="container">
                    <div class="row">
                        <div class="slide-text slide_style_left">
                            <h1 data-animation="animated zoomInRight">The right help at the right time</h1>
                            <p data-animation="animated fadeInLeft">With her professional experience lasting for more than 25 years,  Dr Joanna Bryan is the right call for patients suffering from depression,  anqiety or longing for psychiatrist assistance.</p>
                            <a href="#" target="_blank"  class="btn btn-primary" data-animation="animated fadeInRight">FIND OUT MORE</a>
            ...
            <div class="item">
                <img src="images/slider3.jpg"   class="slide-image"/>
                <div class="bs-slider-overlay"><img src="images/overlay.png"></div>
            </div>
         </div>
    </div>
    ...
    <script>
        $("document").ready(function(){
            ...
            $("#patientClick").click(function(){
                // Store
                localStorage.setItem("patient", "patient");
            });

            $("#doctorClick").click(function(){
                // Store
                localStorage.setItem("doctor", "doctor");
            });

            $("#pharmistClick").click(function(){
                // Store
                localStorage.setItem("pharmist", "pharmist");
            })
