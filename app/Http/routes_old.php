...
Route::group(['prefix' => 'api/v1'], function()
{
   ...
   Route::get('show/all/medicalhistory/user_id/{user_id}', 'Api\ApiMedicalHistoryController@showAllMedicalHistory');
    ...
    Route::post('find/user/by/param', 'Api\ApiFindUserController@showUser');
    ...
    Route::post('doctor/update/appointment/{id?}', 'Api\ApiDoctorController@updateCreate');

    Route::post('doctor/appointment/cancel/user_id/{id}', 'Api\ApiDoctorController@cancel');
