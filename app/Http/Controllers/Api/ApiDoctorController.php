...
class ApiDoctorController extends Controller
{
    ...
    public function updateCreate(Request $request, $user_id, $appointment_id, $id=0)
    {

        
    	$appointmentRequest = AppointmentRequest::find($appointment_id);

        $patient = User::find($appointmentRequest->user_id);
        ...
        $nearBy = \DB::select(
            ...
            $doctorPrescription->for_patient = $appointmentRequest->user_id;
            ...
            $doctorPrescription->appointment_id = $appointment_id;
    ...
    public function cancel(Request $request, $appointment_id, $user_id){
